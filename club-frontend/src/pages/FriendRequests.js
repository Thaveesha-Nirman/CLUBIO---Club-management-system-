 ...
 * * UI component for managing incoming and outgoing friend requests.
 */
...
const FriendRequests = ({ onUserClick }) => {
  ...
  /**
   * * Member 05 : Fetches both received and sent friend requests.
   */
  ...
  /**
   * * Member 05 : Handles accepting or rejecting friend requests.
   */
